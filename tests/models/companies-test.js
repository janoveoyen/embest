...
describe('Companies model', function() {
    ...
    describe("addCompany()", function() {
        ...
        describe("Adding company", function() {
            ...
            it("Should save the correct company to the correct collection", function(done) {
            ...
            it("Should return error on inserting existing company (by orgNr)", function(done) {
